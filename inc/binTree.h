...
/**
  * @brief Destroy function to terminate elements from tree
  * @param[in] pointer to storaged data.
  */
 ...
 */
void  BSTreeDestroy(BSTree* _tree, Destroyer _destroyer);
