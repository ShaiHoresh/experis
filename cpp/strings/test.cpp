...
int main()
{
    ...
    while(flag)
    {
        ...
        {
            case 1:
                cout << "the length of the string is "<< s2.Length() << endl;
            break;  
            case 2:
            ...
            break;
            case 12:
                cout << "capacity is: " << s1.GetClassCapacity() << endl;
            break;
            case 13:
                cout << "want to change capacity to 23" << endl;
                cout << "previous capacity is: " << s1.SetClassCapacity(23) << endl;
                cout << "new capacity is: " << s1.GetClassCapacity() << endl;
            break;
            case 14:
