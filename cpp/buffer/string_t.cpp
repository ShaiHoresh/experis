...
String_t::String_t(const String_t& _src):Buffer()
{
    CreateFrom(_src.str);
    ++numOfStrings;
}

String_t::String_t(const char* _src):Buffer(_src)
{
...
const String_t& String_t::operator+=(const String_t& _str)
{
 ...
 bool String_t::operator<(const String_t& _str)
{
...
String_t String_t::operator()(int _start, unsigned int _len)
{
    ...
    return String_t(str + _start, (size_t)_len);
}

String_t::String_t(const char* _str, size_t _len):Buffer(_str, _len)
{
